...
if __name__ == "__main__":
    ...
    # Instantiate new symbol table
    st = SymbolTable()

    # Add new entries
    st.add_entry('LOOP', 16)
    st.add_entry('END', 32)

    # Check if a symbol is in the table
    print(st.contains('LOOP'))  # Output: True
    print(st.contains('UNKNOWN'))  # Output: False

    # Get the address of a symbol
    print(st.retrive_address('END'))  # Output: 32
    print(st.retrive_address('UNKNOWN'))  # Output: None
